# Generated by Powerlevel10k configuration wizard on 2021-06-14 at 21:20 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_FOREGROUND=214
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_FOREGROUND=39
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_FOREGROUND=190
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='ﴕ'
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}烙${VCS_STATUS_NUM_STAGED}"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=1
  ...
  typeset -g POWERLEVEL9K_ASDF_PHP_BACKGROUND=56
  ...
  # Custom icon.
  # typeset -g POWERLEVEL9K_TODO_VᏆISUAL_IDENTIFIER_EXPANSION='⭐'
  ...
  typeset -g POWERLEVEL9K_NODENV_BACKGROUND=22
  ...
  typeset -g POWERLEVEL9K_NODEENV_BACKGROUND=22
  ...
  typeset -g POWERLEVEL9K_PHP_VERSION_BACKGROUND=56
  ...
  typeset -g POWERLEVEL9K_PHPENV_BACKGROUND=56
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      ...
      '*'         OTHER)
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_FOREGROUND=15
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_BACKGROUND=57
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|ecs-cli|ecs'
  ...
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=166
  ...
  typeset -g POWERLEVEL9K_AWS_EB_ENV_BACKGROUND=166
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_AZURE_BACKGROUND=25
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_GCLOUD_BACKGROUND=33
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_DEFAULT_BACKGROUND=33
  ...
  typeset -g POWERLEVEL9K_VPN_IP_BACKGROUND=46
  ...
  typeset -g POWERLEVEL9K_WIFI_BACKGROUND=0
  # Custom icon.
  ...
  typeset -g my_wifi_fg=(9 172 11 70 10)
  typeset -g my_wifi_icon=(    )
  typeset -g POWERLEVEL9K_WIFI_CONTENT_EXPANSION='%F{${my_wifi_fg[P9K_WIFI_BARS+1]}}$P9K_WIFI_RSSI'
  typeset -g POWERLEVEL9K_WIFI_VISUAL_IDENTIFIER_EXPANSION='%F{${my_wifi_fg[P9K_WIFI_BARS+1]}}${my_wifi_icon[P9K_WIFI_BARS+1]}'
